...
* `devtools::install_github(
  "jonathanbratt/RBERT", build_vignettes = TRUE)`
...
.Large[
* `devtools::install_github(
  "jonathanbratt/RBERTviz", build_vignettes = TRUE)`
* Helper package
...
Layer 0 (initial vectors) *Oh crap, should this be animated?*

```{r layer-0-labeled-count, echo=FALSE}
trains_output_labeled %>% 
  dplyr::filter(
    stringr::str_detect(token, "^train"),
    layer_index == 0
